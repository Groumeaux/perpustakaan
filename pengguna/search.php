...
if (isset($_GET['query'])) {
    ...
    $sql = "SELECT id_buku, judul_buku, pengarang, penerbit, th_terbit, isbn, cover FROM tb_buku WHERE";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<div class="col-md-3 col-sm-6">';
                echo '<div class="panel panel-default">';
                    echo '<button class="btn btn-success" style="position: absolute; top: 5px; right: 5px; z-index: 10;" onclick="confirmAction(\'' . htmlspecialchars($row['id_buku'], ENT_QUOTES, 'UTF-8') . '\')">Reservasi</button>';

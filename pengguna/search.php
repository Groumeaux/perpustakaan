...
if (isset($_GET['query'])) {
    ...
    $sql = "SELECT id_buku, judul_buku, pengarang, penerbit, th_terbit, isbn, cover, jml_buku FROM tb_buku WHERE";
                    ...
                    <div class="panel panel-default ' . htmlspecialchars($disablecard, ENT_QUOTES, 'UTF-8') . '" style="position: relative;">
                        ...
                        <div class="book-overlay" style="display: none; overflow : auto;">
                            <div class="overlay-content">
                                ...
                                <button class="btn btn-success" onclick="confirmAction(\'' . htmlspecialchars($row['id_buku'], ENT_QUOTES, 'UTF-8') . '\')">Reserve</button>
                            </div>
                        </div>
                    </div>
                </div>';
